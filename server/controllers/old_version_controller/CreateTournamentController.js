...
export default async function CreateTournamentController(req, res) {
    const { name, start_date, end_date, maxNmbrParticipants, game } = req.body;
    let tournament = await CreateTournamentModel(name, start_date, end_date, maxNmbrParticipants, game);
